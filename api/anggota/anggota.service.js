...
module.exports = {
    add:(data,callBack)=>{
        db.query(`insert into tb_anggota set ?`,[data],(err,results)=>{
            if(err){
                return callBack(err)
            }else{
    ...
    get:(callBack)=>{
        db.query(`select * from tb_anggota`,[],(err,results)=>{
            if(err){
                return callBack(err)
            }else{
                return callBack(null, results)
    ...
    getId:(data,callBack)=>{
        db.query(`select * from tb_anggota where kd_anggota = ?`,[data],(err,results)=>{
            if(err){
                return callBack(err)
            }else{
                return callBack(null,results)
