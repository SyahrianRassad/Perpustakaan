...
module.exports = {
    //body : kd_petugas, nm_petugas, jabatan, tlpn_petugas, email, password
    ...
    //body: kd_petugas, nm_petugas, jabatan, tlpn_petugas
    ...
    controllerLogin:(req,res)=>{
        ...
        if(result ){
            ...
            const jsonwebtoken = sign({result:results},"secretkey",{expiresIn:"1h"})
